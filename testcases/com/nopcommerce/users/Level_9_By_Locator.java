...
public class Level_9_By_Locator extends BaseTest {
    ...
    public void TC_02_DoNot_Required_Login() {
        ...
        // Do tài khoản admin đã login rồi, nên userHomePage.openAdminSite(driver, adminUrl) sẽ mở luôn trang adminDashboardPage
