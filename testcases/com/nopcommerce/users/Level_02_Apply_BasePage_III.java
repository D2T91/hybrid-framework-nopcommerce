...
public class Level_02_Apply_BasePage_III extends BasePage {
    ...
    public void TC_01_Register_Empty_Data() {
        ...
        Assert.assertEquals(getElementText(driver, "//span[@id='Password-error']"), "Password must meet the following rules: must have at least 6 characters and not greater than 64 characters");
