...
public class HomePageUI {
    ...
    public static final String DYNAMIC_TEXTBOX_BY_HEADERNAME = "xpath=//div[@class='qgrd-header-text' and text() = '%s']/parent::div/following-sibling::input";
    ...
    public static final String DYNAMIC_DELETE_BUTTON_BY_COUNTRYNAME = "xpath=//td[text()='%s']/preceding-sibling::td[@class='qgrd-actions']/button[@class='qgrd-remove-row-btn']";
    public static final String DYNAMIC_EDIT_BUTTON_BY_COUNTRYNAME = "xpath=//td[text()='%s']/preceding-sibling::td[@class='qgrd-actions']/button[@class='qgrd-edit-row-btn']";
